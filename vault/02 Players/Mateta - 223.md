...
Nailed central-forward profile creates meaningful replacement value.
...
- 2026-08-01 22:43 AEST — Assessed in the ranks 17–32 stable pairwise block and placed at rank 21.
...
- Internal Palace rank: **1 of 16**.
- Overall rank: **21** (was 21).
- Comparator outcome: best raw-points projection, central-forward role and penalties potential.
...
- Forward order: **7 of 52** after the first 30-player block with challengers 31–35.
- Overall rank: **21 → 21**.
