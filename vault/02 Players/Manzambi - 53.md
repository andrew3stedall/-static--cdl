...
The player belongs around ranks **276–286** pending direct role, preseason and first-team minutes evidence.
...
- New overall rank: **317** (previously 281).
- Internal club order: **17 of 19**.
- Decision: upside beats the final defensive depth options.
...
- Midfield order: **140** after the final block with challengers 116–120.
- Overall rank: **317 → 325**.
