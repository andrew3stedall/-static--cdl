...
- Ranks below [[02 Players/Bassey - 257|Bassey]] after expected-points, minutes and risk comparison.
- Ranks above [[02 Players/Lammens - 412|Lammens]] after expected-points, minutes and draft replacement-value comparison.
...
- Internal Fulham rank: **14 of 18**.
- Overall rank: **310** (was 152).
- Comparator outcome: minutes floor with low direct attacking output.
...
- Midfield order: **130** after the final block with challengers 116–120.
- Overall rank: **310 → 300**.
