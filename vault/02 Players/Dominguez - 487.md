...
The player belongs around ranks **299–309** pending direct role, preseason and first-team minutes evidence.
...
- Internal Forest rank: **17 of 18**.
- Overall rank: **304** (was 304).
- Segment/tier: **Extended watch buffer / Watch**.
- Comparator outcome: rotation-level midfield upside with limited route to returns.
...
- Midfield order: **129** after the final block with challengers 116–120.
- Overall rank: **304 → 296**.
