...
- Below [[02 Players/Simms - 195|Simms]] after raw points, minutes, role and risk comparison.
- Above [[02 Players/Thomas - 173|Thomas]] after the same draft comparator.
...
- Internal Palace rank: **10 of 16**.
- Overall rank: **214** (was 208).
...
- Midfield order: **90** after block 4 with challengers 86–90 and 121–125.
- Overall rank: **214 → 214**.
- Raw expected points were compared before minutes, role, set pieces, injury/rotation risk, floor and ceiling.
