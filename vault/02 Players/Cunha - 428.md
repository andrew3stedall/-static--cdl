...
Central attacker in a team with only one opponent above FDR 3 in the first eight.

## Pairwise placement

- Compared with: **Wirtz**.
- Decision: Cunha has the clearer immediate Premier League role and opening schedule; Wirtz has the higher role-change upside.
- Confidence: medium.
- Reversal trigger: material injury, role, penalty or expected-minutes evidence that changes the comparison.

## Evidence timeline

- 2026-08-01 22:07 AEST — Pairwise-sorted to rank 12 in the first-16 block.
...
- Internal Manchester United rank: **3 of 22**.
- Overall rank: **12** (was 12).
...
- Overall block order: **11** after comparing ranks 1–30 with challengers 31–35.
- Overall rank: **12 → 11**.
