...
The player belongs around ranks **286–296** pending direct role, preseason and first-team minutes evidence.
...
- New overall rank: **300** (previously 291).
- Internal club order: **16 of 19**.
- Decision: set-piece possibility and experience edge the youth/depth options.
...
- Midfield order: **121** after the final block with challengers 116–120.
- Overall rank: **300 → 284**.
