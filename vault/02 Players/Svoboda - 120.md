...
The player belongs around ranks **302–312** pending direct role, preseason and first-team minutes evidence.
...
- Internal Brighton rank: **22 of 23**.
- Overall rank: **309** (was 307).
- Comparator outcome: low-confidence defensive depth.
...
- Defender order: **114** after the final block with challengers 86–90.
- Overall rank: **309 → 326**.
