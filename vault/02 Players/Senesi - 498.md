...
- Immediate ordering remains Fernandes / Senesi / Van Hecke; no new player-specific evidence justified a separate move.
- Confidence: medium.
...
- Defender order: **25** after block 1 with challengers 31–35.
- Overall rank: **143 → 139**.
...
- Defender order: **41** after block 2 with challengers 26–30 and 61–65.
- Overall rank: **139 → 149**.
- Raw expected points were compared before minutes, attacking role, clean-sheet environment, set pieces, injury/rotation risk, floor and ceiling.
