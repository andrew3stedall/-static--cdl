...
- Ranks below [[02 Players/Canvot - 203|Canvot]] after the raw-points comparison and risk adjustment.
- Ranks above [[02 Players/Delap - 167|Delap]] after expected-minutes, ceiling and replacement-value comparison.
...
- Internal City rank: **20 of 22**.
- Overall rank: **254** (was 185).
- Segment/tier: **Undrafted buffer / D**.
- Comparator outcome: centre-back depth with uncertain starts.
...
- Defender order: **77** after block 3 with challengers 56–60 and 91–95.
- Overall rank: **254 → 248**.
