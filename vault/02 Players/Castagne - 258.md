...
The player belongs around ranks **241–251** pending direct role, preseason and first-team minutes evidence.
...
- Internal Fulham rank: **16 of 18**.
- Overall rank: **318** (was 246).
- Comparator outcome: rotation-level full-back value.
...
- Defender order: **91** after the final block with challengers 86–90.
- Overall rank: **318 → 274**.
