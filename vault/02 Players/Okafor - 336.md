...
Ranked 90 after the ranks 81–110 review with challengers from 76–115. Official FPL ID 336 remains active in the API pool.

## Direct comparison

- Compared with: **O'Reilly**.
- Raw expected-points judgement: Okafor is currently preferred.
- Draft decision: Okafor has the more direct route to attacking returns when starting.
- Confidence: medium.
...
- API minutes field: 1553

## Evidence timeline

- 2026-08-02 08:15 AEST — Pairwise-reviewed and placed at rank 90.
...
Rank updated to 94 after the unranked-player top-140 screen. Evidence: [[06 Reviews/2026/08/2026-08-02/1012-AEST-review]].

## 2026-08-02 14:00 block recheck

- Rank **94** retained after direct comparison with adjacent ranks and challengers 76–115.
