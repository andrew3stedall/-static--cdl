...
Ranked 88 after the ranks 81–110 review with challengers from 76–115. Official FPL ID 491 remains active in the API pool.

## Direct comparison

- Compared with: **Groß**.
- Raw expected-points judgement: Igor Jesus is currently preferred.
- Draft decision: Forward replacement value narrowly lifts Igor Jesus over Groß.
- Confidence: medium.
...
- API total points field: 114
- API minutes field: 2293

## Evidence timeline

- 2026-08-02 08:15 AEST — Pairwise-reviewed and placed at rank 88.
...
- Rank **92** retained after direct comparison with adjacent ranks and challengers 76–115.
