...
- Ranks below [[02 Players/Verbruggen - 109|Verbruggen]] after expected-points, minutes and risk comparison.
- Ranks above [[02 Players/Aaronson - 337|Aaronson]] after expected-points, minutes and draft replacement-value comparison.
...
- Internal Forest rank: **9 of 18**.
- Overall rank: **180** (was 139).
- Segment/tier: **Undrafted buffer / D**.
- Comparator outcome: secure centre-back minutes, clean sheets and aerial threat.
...
- Defender order: **53** after block 2 with challengers 26–30 and 61–65.
- Overall rank: **180 → 175**.
