...
- Immediate ordering remains Guéhi / Doku / E.Le Fée; no new player-specific evidence justified a separate move.
- Confidence: medium.
...
- Internal City rank: **6 of 22**.
- Overall rank: **40** (was 42).
- Segment/tier: **Core / B**.
- Comparator outcome: explosive winger ceiling with major minutes volatility.
...
- Midfield order: **25** after block 1 with challengers 31–35.
- Overall rank: **40 → 38**.
