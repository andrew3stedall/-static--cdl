...
- Rank: **346** (previously unranked)
- Segment/tier: **Extended watch buffer / Watch**
- Status: Back injury - Unknown return date
...
The player belongs around ranks **341–350** pending direct role, preseason and first-team minutes evidence.
...
- Internal Manchester United rank: **19 of 22**.
- Overall rank: **306** (was 346).
- Segment/tier: **Extended watch buffer / Watch**.
- Comparator outcome: centre-back floor heavily discounted by back injury.
...
- Defender order: **94** after the final block with challengers 86–90.
- Overall rank: **306 → 280**.
...
- Overall rank: **267 -> 186**.
- Current status: **Back surgery; Premier Injuries potential return 6 Sep 2026**.
