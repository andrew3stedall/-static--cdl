...
High-value attacking role and possible penalties, moderated by difficult opening fixtures.

## Pairwise placement

- Compared with: [[02 Players/Tavernier]]
- Decision: Kluivert has the stronger central and penalty upside; reverse if Tavernier clearly owns more set pieces and minutes.
- Confidence: Medium
...
- 2026-08-01 22:43 AEST — Assessed in the ranks 17–32 stable pairwise block and placed at rank 22.
...
- Midfield order: **13** after block 1 with challengers 31–35.
- Overall rank: **22 → 20**.
...
- Overall block order: **20** after comparing ranks 1–30 with challengers 31–35.
- Overall rank: **20 → 20**.
