...
Ranked 91 after the ranks 81–110 review with challengers from 76–115. Official FPL ID 387 remains active in the API pool.

## Direct comparison

- Compared with: **Matheus N.**.
- Raw expected-points judgement: O'Reilly is currently preferred.
- Draft decision: O’Reilly has the higher attacking-defender ceiling, but both carry major rotation risk.
- Confidence: low.
...
- API total points field: 160
- API minutes field: 2643

## Evidence timeline

- 2026-08-02 08:15 AEST — Pairwise-reviewed and placed at rank 91.
...
Rank updated to 95 after the unranked-player top-140 screen. Evidence: [[06 Reviews/2026/08/2026-08-02/1012-AEST-review]].

## 2026-08-02 14:00 block recheck

- Rank **95** retained after direct comparison with adjacent ranks and challengers 76–115.
...
- Internal City rank: **11 of 22**.
- Overall rank: **95** (was 95).
- Segment/tier: **Depth / C**.
- Comparator outcome: attacking defender upside with rotation risk.
...
- Defender order: **21** after block 1 with challengers 31–35.
- Overall rank: **95 → 122**.
