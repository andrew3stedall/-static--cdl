...
The player belongs around ranks **277–287** pending direct role, preseason and first-team minutes evidence.
...
- Internal Brentford rank: **16 of 20**.
- Overall rank: **282** (was 282).
- Comparator outcome: minutes floor with limited direct FPL ceiling.
...
- Midfield order: **119** after the final block with challengers 116–120.
- Overall rank: **282 → 282**.
- Raw expected points were compared before minutes, role, set pieces, injury/rotation risk, floor and ceiling.
