...
Ranked 102 after the ranks 81–110 review with challengers from 76–115. Official FPL ID 28 remains active in the API pool.

## Direct comparison

- Compared with: **Keane**.
- Raw expected-points judgement: Martinez is currently preferred.
- Draft decision: Martinez has a secure goalkeeper floor; Keane’s starting role is less certain.
- Confidence: medium.
...
- API total points field: 120
- API minutes field: 2835

## Evidence timeline

- 2026-08-02 08:15 AEST — Pairwise-reviewed and placed at rank 102.
