...
- Immediate ordering remains Kudus / Barnes / Maddison; no new player-specific evidence justified a separate move.
- Confidence: medium.
...
- Internal Newcastle rank: **2 of 19**.
- Overall rank: **54** (was 58).
- Segment/tier: **Core / B-**.
- Comparator outcome: proven direct goal threat and strong per-minute ceiling.
...
- Midfield order: **32** after block 1 with challengers 31–35.
- Overall rank: **54 → 49**.
