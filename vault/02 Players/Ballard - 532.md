...
Ranked 95 after the ranks 81–110 review with challengers from 76–115. Official FPL ID 532 remains active in the API pool.

## Direct comparison

- Compared with: **Romero**.
- Raw expected-points judgement: Ballard is currently preferred.
- Draft decision: Ballard is preferred for aerial threat and a steadier disciplinary profile.
- Confidence: medium.
...
- API total points field: 116
- API minutes field: 2144

## Evidence timeline

- 2026-08-02 08:15 AEST — Pairwise-reviewed and placed at rank 95.
...
Rank updated to 101 after the unranked-player top-140 screen. Evidence: [[06 Reviews/2026/08/2026-08-02/1012-AEST-review]].

## 2026-08-02 14:00 block recheck

- Rank **101** retained after direct comparison with adjacent ranks and challengers 76–115.
...
- Defender order: **55** after block 2 with challengers 26–30 and 61–65.
- Overall rank: **175 → 177**.
- Raw expected points were compared before minutes, attacking role, clean-sheet environment, set pieces, injury/rotation risk, floor and ceiling.
