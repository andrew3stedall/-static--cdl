...
The player belongs around ranks **255–265** pending direct role, preseason and first-team minutes evidence.
...
- Internal Palace rank: **5 of 16**.
- Overall rank: **87** (was 260).
- Comparator outcome: proven Premier League scoring ceiling but less secure role.
...
- Forward order: **23 of 52** after the first 30-player block with challengers 31–35.
- Overall rank: **90 → 90**.
