...
The player belongs around ranks **280–290** pending direct role, preseason and first-team minutes evidence.
...
- Internal Leeds rank: **16 of 18**.
- Overall rank: **285** (was 285).
- Segment/tier: **Extended watch buffer / Watch**.
- Comparator outcome: senior minutes potential with modest FPL ceiling.
...
- Midfield order: **122** after block 4 with challengers 86–90 and 121–125.
- Overall rank: **285 → 285**.
...
- Midfield order: **136** after the final block with challengers 116–120.
- Overall rank: **285 → 314**.
- Raw expected points were compared before minutes, role, set pieces, injury/rotation risk, floor and ceiling.
