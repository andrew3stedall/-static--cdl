...
- Below [[02 Players/N.Jackson - 166|N.Jackson]] after raw points, minutes, role and risk comparison.
- Above [[02 Players/Alleyne - 394|Alleyne]] after the same draft comparator.
...
- Internal Manchester United rank: **14 of 22**.
- Overall rank: **202** (was 197).
- Segment/tier: **Undrafted buffer / D**.
...
- Midfield order: **86** after block 4 with challengers 86–90 and 121–125.
- Overall rank: **202 → 202**.
- Raw expected points were compared before minutes, role, set pieces, injury/rotation risk, floor and ceiling.
