...
- Immediate ordering remains Wood / Woltemade / Amad; no new player-specific evidence justified a separate move.
- Confidence: medium.
...
- Internal Newcastle rank: **4 of 19**.
- Overall rank: **62** (was 54).
- Segment/tier: **Core / B-**.
- Comparator outcome: central attacking role and forward scarcity, with role uncertainty.
...
- Forward order: **15 of 52** after the first 30-player block with challengers 31–35.
- Overall rank: **58 → 58**.
