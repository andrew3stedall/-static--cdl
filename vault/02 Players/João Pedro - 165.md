...
Forward classification and attacking quality retain early value, discounted for Chelsea competition.

## Pairwise placement

- Compared with: **Cunha**.
- Decision: João Pedro is drafted first because comparable points expectation plus forward scarcity offsets Cunha's safer opening fixtures.
- Confidence: medium.
- Reversal trigger: material injury, role, penalty or expected-minutes evidence that changes the comparison.

## Evidence timeline

- 2026-08-01 22:07 AEST — Pairwise-sorted to rank 11 in the first-16 block.
...
- Internal Chelsea rank: **2 of 25**.
- Overall rank: **11** (was 11).
- Comparator outcome: best current forward blend of role and scarcity.
...
- Forward order: **6 of 52** after the first 30-player block with challengers 31–35.
- Overall rank: **11 → 11**.
...
- Overall block order: **10** after comparing ranks 1–30 with challengers 31–35.
- Overall rank: **11 → 10**.
