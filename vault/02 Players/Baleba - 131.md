...
The player belongs around ranks **252–262** pending direct role, preseason and first-team minutes evidence.
...
- Internal Brighton rank: **18 of 23**.
- Overall rank: **289** (was 257).
- Comparator outcome: secure midfield role with low FPL ceiling.
...
- Midfield order: **124** after block 4 with challengers 86–90 and 121–125.
- Overall rank: **289 → 289**.
...
- Midfield order: **138** after the final block with challengers 116–120.
- Overall rank: **289 → 322**.
- Raw expected points were compared before minutes, role, set pieces, injury/rotation risk, floor and ceiling.
...
- Overall rank: **306 -> 334**.
- Current status: **Ankle injury - Expected back 23 Aug**.
