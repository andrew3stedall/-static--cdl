...
The player belongs around ranks **295–305** pending direct role, preseason and first-team minutes evidence.
...
- New overall rank: **269** (previously 300).
- Internal club order: **11 of 19**.
...
- Defender order: **86** after the final block with challengers 86–90.
- Overall rank: **265 → 265**.
- Raw expected points were compared before minutes, attacking role, clean-sheet environment, set pieces, injury/rotation risk, floor and ceiling.
