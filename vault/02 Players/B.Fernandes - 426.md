...
235 points, penalties, corners, 7.6 points per match under Carrick and favourable opening fixtures.

## Pairwise placement

- Compared with: **Saka**.
- Decision: Bruno has the stronger demonstrated current scoring baseline and safer set-piece monopoly.
- Confidence: medium-high.
- Reversal trigger: material injury, role, penalty or expected-minutes evidence that changes the comparison.

## Evidence timeline

- 2026-08-01 22:07 AEST — Pairwise-sorted to rank 2 in the first-16 block.
...
- Midfield order: **3** after block 1 with challengers 31–35.
- Overall rank: **2 → 5**.
...
- Overall block order: **5** after comparing ranks 1–30 with challengers 31–35.
- Overall rank: **5 → 5**.
