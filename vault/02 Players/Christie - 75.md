...
- Rank: **344** (previously unranked)
- Segment/tier: **Extended watch buffer / Watch**
- Status: Suspended until 29 Aug
...
The player belongs around ranks **339–349** pending direct role, preseason and first-team minutes evidence.
...
- Internal rank: **19 of 19**.
- Overall rank: **344** (was 344).
- Comparator outcome: suspension and limited ceiling.
...
- Midfield order: **134** after the final block with challengers 116–120.
- Overall rank: **344 → 311**.
...
- Current status: **Suspended until 29 Aug**.
