...
The player belongs around ranks **246–256** pending direct role, preseason and first-team minutes evidence.
...
- Internal rank: **17 of 19**.
- Overall rank: **323** (was 251).
- Comparator outcome: uncertain role.
...
- Defender order: **105** after the final block with challengers 86–90.
- Overall rank: **323 → 306**.
...
- Overall rank: **308 -> 336**.
- Current status: **Unspecified injury - Unknown return date**.
