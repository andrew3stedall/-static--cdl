...
Ranked 94 after the ranks 81–110 review with challengers from 76–115. Official FPL ID 200 remains active in the API pool.

## Direct comparison

- Compared with: **Ballard**.
- Raw expected-points judgement: Lacroix is currently preferred.
- Draft decision: Lacroix has the stronger combination of minutes and clean-sheet environment.
- Confidence: medium.
...
- API minutes field: 3085

## Evidence timeline

- 2026-08-02 08:15 AEST — Pairwise-reviewed and placed at rank 94.
