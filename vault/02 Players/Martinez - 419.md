...
- Rank: **296** (previously unranked)
- Segment/tier: **Extended watch buffer / Watch**
- Status: Thigh injury - 75% chance of playing
...
The player belongs around ranks **291–301** pending direct role, preseason and first-team minutes evidence.
...
- Internal Manchester United rank: **12 of 22**.
- Overall rank: **197** (was 111).
...
- Defender order: **63** after block 3 with challengers 56–60 and 91–95.
- Overall rank: **197 → 188**.
- Raw expected points were compared before minutes, attacking role, clean-sheet environment, set pieces, injury/rotation risk, floor and ceiling.
...
- Overall rank: **177 -> 179**.
- Current status: **Thigh injury - 75% chance of playing**.
