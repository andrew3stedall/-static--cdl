...
- Immediate ordering remains Schade / Gvardiol / Guéhi; no new player-specific evidence justified a separate move.
- Confidence: medium.
...
- Internal City rank: **7 of 22**.
- Overall rank: **41** (was 40).
- Segment/tier: **Core / B**.
- Comparator outcome: best defender blend of clean sheets, minutes and attacking upside.
...
- Defender order: **5** after block 1 with challengers 31–35.
- Overall rank: **41 → 42**.
