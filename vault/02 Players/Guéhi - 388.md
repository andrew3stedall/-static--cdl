...
- Immediate ordering remains Gvardiol / Guéhi / Doku; no new player-specific evidence justified a separate move.
- Confidence: medium.
...
- Internal City rank: **8 of 22**.
- Overall rank: **42** (was 41).
- Segment/tier: **Core / B**.
- Comparator outcome: secure centre-back floor and aerial route.
...
- Defender order: **11** after block 1 with challengers 31–35.
- Overall rank: **42 → 82**.
