...
The player belongs around ranks **272–282** pending direct role, preseason and first-team minutes evidence.
...
- Internal Brentford rank: **12 of 20**.
- Overall rank: **217** (was 277).
- Comparator outcome: direct attacking ceiling with uncertain starting status.
...
- Midfield order: **91** after block 3 with challengers 56–60 and 91–95.
- Overall rank: **217 → 217**.
...
- Midfield order: **92** after block 4 with challengers 86–90 and 121–125.
- Overall rank: **217 → 218**.
- Raw expected points were compared before minutes, role, set pieces, injury/rotation risk, floor and ceiling.
