...
The player belongs around ranks **238–248** pending direct role, preseason and first-team minutes evidence.
...
- Internal Forest rank: **16 of 18**.
- Overall rank: **294** (was 243).
- Segment/tier: **Extended watch buffer / Watch**.
- Comparator outcome: minutes floor with weak direct FPL output.
...
- Midfield order: **128** after the final block with challengers 116–120.
- Overall rank: **294 → 295**.
