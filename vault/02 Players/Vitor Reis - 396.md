...
The player belongs around ranks **249–259** pending direct role, preseason and first-team minutes evidence.
...
- Internal City rank: **22 of 22**.
- Overall rank: **315** (was 254).
- Segment/tier: **Extended watch buffer / Watch**.
- Comparator outcome: lowest current first-team role certainty in the ranked City pool.
...
- Defender order: **109** after the final block with challengers 86–90.
- Overall rank: **315 → 315**.
