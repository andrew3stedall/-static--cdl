...
- Ranks below [[02 Players/F.Kadıoğlu - 113|F.Kadıoğlu]] after expected-points, minutes and risk comparison.
- Ranks above [[02 Players/Kayode - 88|Kayode]] after expected-points, minutes and draft replacement-value comparison.
...
- Internal Tottenham rank: **10 of 26**.
- Overall rank: **102** (was 143).
- Segment/tier: **Depth / C**.
- Comparator outcome: minutes and clean-sheet floor with some transition threat.
