...
The player belongs around ranks **316–326** pending direct role, preseason and first-team minutes evidence.
...
- Internal Manchester United rank: **18 of 22**.
- Overall rank: **299** (was 321).
- Segment/tier: **Extended watch buffer / Watch**.
- Comparator outcome: development upside with low first-choice certainty.
...
- Defender order: **100** after the final block with challengers 86–90.
- Overall rank: **299 → 299**.
