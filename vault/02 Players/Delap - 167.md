...
- Ranks below [[02 Players/Khusanov - 393|Khusanov]] after the raw-points comparison and risk adjustment.
- Ranks above [[02 Players/Awoniyi - 492|Awoniyi]] after expected-minutes, ceiling and replacement-value comparison.
...
- Internal Chelsea rank: **7 of 25**.
- Overall rank: **72** (was 186).
- Comparator outcome: forward scarcity and strong goal threat.
...
- Forward order: **17 of 52** after the first 30-player block with challengers 31–35.
- Overall rank: **70 → 70**.
