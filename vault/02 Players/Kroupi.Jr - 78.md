...
- Rank: **286** (previously 243)
- Segment/tier: **Extended watch buffer / Watch**
- Status: Foot injury - Unknown return date
...
The player belongs around ranks **281–291** pending direct role, preseason and first-team minutes evidence.
...
- Internal rank: **13 of 19**.
- Overall rank: **267** (was 286).
- Comparator outcome: ceiling discounted by injury.
...
- Midfield order: **110** after block 4 with challengers 86–90 and 121–125.
- Overall rank: **267 → 260**.
...
- Overall rank: **260 -> 279**.
- Current status: **Foot injury - Unknown return date**.
