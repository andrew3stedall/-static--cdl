...
- Immediate ordering remains Cherki / Marmoush / Ndiaye; no new player-specific evidence justified a separate move.
- Confidence: medium.
...
- Internal City rank: **5 of 22**.
- Overall rank: **37** (was 37).
- Segment/tier: **Core / B**.
- Comparator outcome: central-forward routes and scarcity, discounted for competition.
...
- Forward order: **10 of 52** after the first 30-player block with challengers 31–35.
- Overall rank: **37 → 37**.
