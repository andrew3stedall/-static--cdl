...
- Ranks below [[02 Players/Yeremy - 211|Yeremy]] after the raw-points comparison and risk adjustment.
- Ranks above [[02 Players/Hinshelwood - 123|Hinshelwood]] after expected-minutes, ceiling and replacement-value comparison.
...
- Internal Leeds rank: **11 of 18**.
- Overall rank: **171** (was 168).
- Segment/tier: **Undrafted buffer / D**.
- Comparator outcome: reliable defensive minutes with modest attacking upside.
...
- Defender order: **63** after block 2 with challengers 26–30 and 61–65.
...
- Defender order: **87** after the final block with challengers 86–90.
- Overall rank: **266 → 266**.
- Raw expected points were compared before minutes, attacking role, clean-sheet environment, set pieces, injury/rotation risk, floor and ceiling.
