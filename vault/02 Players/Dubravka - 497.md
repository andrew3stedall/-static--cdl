...
This player was insertion-sorted from rank 230 to 209. backup-goalkeeper uncertainty keeps him below secure starters.

## Direct range comparison

Placed between **Pinnock** and **Milosavljević**.
