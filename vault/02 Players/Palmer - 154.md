...
Two prior 200-point seasons, summer rest and no European football; primary Chelsea attacking hub.

## Pairwise placement

- Compared with: **Thiago**.
- Decision: Palmer is expected to outscore Thiago through assists, bonuses and midfield scoring despite Thiago's scarcity.
- Confidence: medium-high.
- Reversal trigger: material injury, role, penalty or expected-minutes evidence that changes the comparison.

## Evidence timeline

- 2026-08-01 22:07 AEST — Pairwise-sorted to rank 5 in the first-16 block.
...
- Internal Chelsea rank: **1 of 25**.
- Overall rank: **5** (was 5).
- Comparator outcome: elite raw-points projection, penalties and set pieces.
...
- Midfield order: **1** after block 1 with challengers 31–35.
- Overall rank: **5 → 2**.
...
- Overall block order: **2** after comparing ranks 1–30 with challengers 31–35.
- Overall rank: **2 → 2**.
