...
The player belongs around ranks **304–314** pending direct role, preseason and first-team minutes evidence.
...
- Internal Brighton rank: **23 of 23**.
- Overall rank: **320** (was 309).
- Comparator outcome: lowest current Brighton role certainty.
...
- Defender order: **106** after the final block with challengers 86–90.
- Overall rank: **320 → 307**.
