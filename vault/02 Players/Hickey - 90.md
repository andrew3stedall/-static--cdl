...
The player belongs around ranks **326–336** pending direct role, preseason and first-team minutes evidence.
...
- Internal Brentford rank: **18 of 20**.
- Overall rank: **293** (was 331).
- Comparator outcome: upside exists, but fitness and role evidence remain weak.
...
- Defender order: **93** after the final block with challengers 86–90.
- Overall rank: **293 → 278**.
